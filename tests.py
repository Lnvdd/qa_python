...
class TestBooksCollector:
    ...
    def test_add_two_books_count_is_two(self):
    ...
    def test_add_book_with_empty_name_not_added(self, book_name, expected_count):
        collector = BooksCollector()
    ...
    def test_add_duplicate_book_not_duplicate_count(self, book_name):
        collector = BooksCollector()
        collector.add_new_book(book_name)
        collector.add_new_book(book_name)
        assert len(collector.get_books_genre()) == 1

    def test_set_book_genre_first_set(self):
        collector = BooksCollector()
        collector.add_new_book('Дюна')
        collector.set_book_genre('Дюна', 'Детективы')
        assert collector.get_book_genre('Дюна') == 'Детективы'

    def test_set_book_genre_change_to_another(self):
        collector = BooksCollector()
        collector.add_new_book('Дюна')
        collector.set_book_genre('Дюна', 'Детективы')
    ...
    def test_set_book_genre_cannot_change_to_third(self):
        collector = BooksCollector()
        collector.add_new_book('Дюна')
        collector.set_book_genre('Дюна', 'Фантастика')
    ...
    def test_get_book_genre_empty_initially(self):
        collector = BooksCollector()
    ...
    def test_get_books_with_specific_genre_contains_only_right_books(self):
        collector = BooksCollector()
    ...
    def test_get_all_books_genres(self):
        collector = BooksCollector()
    ...
    def test_get_books_for_children_includes_and_excludes_correctly(self):
        collector = BooksCollector()
    ...
    def test_delete_book_from_favorites_with_nonexistent_book(self):
        collector = BooksCollector()
        collector.delete_book_from_favorites('Нет такой книги')
        assert collector.get_list_of_favorites_books() == []

    def test_get_list_of_favorites_initially_empty(self):
        collector = BooksCollector()
        assert collector.get_list_of_favorites_books() == []

    def test_get_list_of_favorites_after_adding(self):
        collector = BooksCollector()
